    ...
    internal class ThreeFiveTwoSchemeDefenition : ISchemeDefinition
    {
        ...
        public Dictionary<int, string> GetPositions()
        {
            return new Dictionary<int, string>()
            {
                ...
                { 4, EnumDescription.GetEnumDescription(PlayerPosition.LeftDefender) },
                { 5, EnumDescription.GetEnumDescription(PlayerPosition.RightMidfilder) },
                { 6, EnumDescription.GetEnumDescription(PlayerPosition.CentraltMidfielder) },
                ...
                { 10, EnumDescription.GetEnumDescription(PlayerPosition.Forward) },
